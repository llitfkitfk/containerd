...
// source: github.com/llitfkitfk/containerd/api/events/snapshot.proto
...
func init() {
	proto.RegisterFile("github.com/llitfkitfk/containerd/api/events/snapshot.proto", fileDescriptorSnapshot)
}
