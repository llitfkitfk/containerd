...
// source: github.com/llitfkitfk/containerd/api/events/task.proto
...
func init() {
	proto.RegisterFile("github.com/llitfkitfk/containerd/api/events/task.proto", fileDescriptorTask)
}
