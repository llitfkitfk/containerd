...
// source: github.com/llitfkitfk/containerd/api/events/namespace.proto
...
func init() {
	proto.RegisterFile("github.com/llitfkitfk/containerd/api/events/namespace.proto", fileDescriptorNamespace)
}
