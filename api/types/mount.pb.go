...
// source: github.com/llitfkitfk/containerd/api/types/mount.proto
...
func init() {
	proto.RegisterFile("github.com/llitfkitfk/containerd/api/types/mount.proto", fileDescriptorMount)
}
