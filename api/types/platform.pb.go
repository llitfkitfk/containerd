...
// source: github.com/llitfkitfk/containerd/api/types/platform.proto
...
func init() {
	proto.RegisterFile("github.com/llitfkitfk/containerd/api/types/platform.proto", fileDescriptorPlatform)
}
