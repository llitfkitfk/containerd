...
// source: github.com/llitfkitfk/containerd/api/types/metrics.proto
...
func init() {
	proto.RegisterFile("github.com/llitfkitfk/containerd/api/types/metrics.proto", fileDescriptorMetrics)
}
