...
// source: github.com/llitfkitfk/containerd/protobuf/google/rpc/status.proto
...
func init() {
	proto.RegisterFile("github.com/llitfkitfk/containerd/protobuf/google/rpc/status.proto", fileDescriptorStatus)
}
